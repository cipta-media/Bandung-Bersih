...
import com.panelic.kacau.parser_artikel.DOMParser;
...
public class MainArtikel extends Activity {
    ...
    private String RSSFEEDURL = "http://www.antaranews.com/rss/wbm.xml";
    RSSFeed feed;
    String fileName;
    ...
    private void startLisActivity(RSSFeed feed) {
        ...
        // launch List Artikel
        Intent intent = new Intent(MainArtikel.this, ListArtikel.class);
