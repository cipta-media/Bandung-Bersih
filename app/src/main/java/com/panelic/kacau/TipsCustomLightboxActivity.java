 ...
 */
public class TipsCustomLightboxActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.tips_youtube_lightbox);
